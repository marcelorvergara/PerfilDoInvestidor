...
import kotlinx.android.synthetic.main.fragment_question_9.*

/**
 * A simple [Fragment] subclass.
 */
class Question_9 : Fragment() {
    var soma : Int = 0
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnProxQuest.setOnClickListener {
            ...
            if (checked != -1) {
                ...
                questionsViewModel!!.respostas["Q9"] = soma
                val ant = questionsViewModel!!.resultado
                if (soma != null) questionsViewModel!!.resultado = soma + ant!!
                //Toast.makeText(this.context!!.applicationContext,"HHH ${questionsViewModel!!.resultado.toString()}", Toast.LENGTH_SHORT).show()

                findNavController().navigate(R.id.action_question_9_to_question_10)
            }
