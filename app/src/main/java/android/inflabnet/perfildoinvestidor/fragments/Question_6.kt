...
import kotlinx.android.synthetic.main.fragment_question_6.*

/**
 * A simple [Fragment] subclass.
 */
class Question_6 : Fragment() {
    var soma : Int = 0
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnVoltar.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_question_6_to_question_5)
        }
        ...
        btnProxQuest.setOnClickListener {
            ...
            if (checked != -1) {
                ...
                questionsViewModel!!.respostas["Q6"] = soma
                val ant = questionsViewModel!!.resultado
                if (soma != null) questionsViewModel!!.resultado = soma + ant!!
                //Toast.makeText(this.context!!.applicationContext,"EEE ${questionsViewModel!!.resultado.toString()}", Toast.LENGTH_SHORT).show()

                findNavController().navigate(R.id.action_question_6_to_question_7)
            }
