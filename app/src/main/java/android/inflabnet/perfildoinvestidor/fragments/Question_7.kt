...
import kotlinx.android.synthetic.main.fragment_question_7.*

/**
 * A simple [Fragment] subclass.
 */
class Question_7 : Fragment() {
    var soma : Int = 0
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_question_7, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnVoltar.setOnClickListener{
            ...
            findNavController().navigate(R.id.action_question_7_to_question_6)
        }
        ...
        btnProxQuest.setOnClickListener {
            ...
            if (checked != -1) {
                ...
                questionsViewModel!!.respostas["Q7"] = soma
                val ant = questionsViewModel!!.resultado
                if (soma != null) questionsViewModel!!.resultado = soma + ant!!
                //Toast.makeText(this.context!!.applicationContext,"FFF ${questionsViewModel!!.resultado.toString()}", Toast.LENGTH_SHORT).show()

                findNavController().navigate(R.id.action_question_7_to_question_8)
            }
