...
import kotlinx.android.synthetic.main.fragment_question_8.*

/**
 * A simple [Fragment] subclass.
 */
class Question_8 : Fragment() {
    var soma : Int = 0
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_question_8, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        btnQuadro8.setOnClickListener {
            findNavController().navigate(R.id.action_question_8_to_imageQ8)
        }
        ...
        btnVoltar.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_question_8_to_question_7)
        }
        ...
        btnProxQuest.setOnClickListener {
            ...
            if (checked != -1) {
                ...
                questionsViewModel!!.respostas["Q8"] = soma
                val ant = questionsViewModel!!.resultado
                if (soma != null) questionsViewModel!!.resultado = soma + ant!!
                //Toast.makeText(this.context!!.applicationContext,"GGG ${questionsViewModel!!.resultado.toString()}", Toast.LENGTH_SHORT).show()

                findNavController().navigate(R.id.action_question_8_to_question_9)
            }
